 ...
 if msg.chat_id then
    ...
    local msgs = tonumber(redis:get(hash) or 0)
	  ...
	  local max_msg = 7 * 1
		...
		sendText(msg.chat_id, msg.id,'> کاربر گرامی، '..(result.first_name or '')..'\n<code>به دلیل ارسال هرزنامه</code><b>(SPAM)</b> <code>در خصوصی ربات، دسترسی شما به طور کامل از ربات قطع میگردد و دیگر قادر به استفاده از خدمات</code>  [ربات مدیریت گروه] <code>نمیباشید.</code>' ,'html')
		end
...
*<b>[/#!]banall list</b> --<code>نمایش لیست کاربران مسدود شده از تمامی گروه های [ربات مدیریت گروه]</code>
*<b>[/#!]delete banalls</b> --<code>حذف لیست کاربران مسدود شده از تمامی گروه های [ربات مدیریت گروه]</code>
...
*<b>[/#!]allowed</b> @username|reply|user-id  1�7-<code>تنظیم کاربر لیست مجاز جدید برای گروه با یوزرنیم|ریپلی|شناسه -فرد</code>
*<b>[/#!]notallowed</b> @username|reply|user-id  1�7-<code>حذف کاربر لیست مجاز جدید برای گروه با یوزرنیم|ریپلی|شناسه -فرد</code>
...
txts = [[ربات فعاله عزیزم عشقم نفسم.مگه میشه رباته حصی آف شه.
]]
